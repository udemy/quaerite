...
import static org.tallison.quaerite.core.serializers.FeatureFactorySerializer.VALUES_KEY;
...
import org.tallison.quaerite.core.features.PF2;
import org.tallison.quaerite.core.features.PF3;
import org.tallison.quaerite.core.features.PS;
import org.tallison.quaerite.core.features.PS2;
import org.tallison.quaerite.core.features.PS3;
...
public class QuerySerializer extends AbstractFeatureSerializer
    ...
    static void deserializeMultiField(MultiFieldQuery q, JsonObject obj) {
        ...
        q.setQF(qf);
        if (obj.has(TIE)) {
            org.tallison.quaerite.core.features.TIE tie = new TIE(obj.get(TIE).getAsFloat());
            q.setTie(tie);
        }
